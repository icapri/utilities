...
describe('Dates', () => {
  ...
  test('Dates.parseISO()', () => {
    ...
    expect(Dates.parseISO('0000')?.toISOString()).toEqual(
        '1900-01-01T00:00:00.000Z',
    ); // this here is the zero-year
    expect(Dates.parseISO('2023')?.toISOString()).toEqual(
        '2023-01-01T00:00:00.000Z',
    );
    expect(Dates.parseISO('2023-05')?.toISOString()).toEqual(
        '2023-05-01T00:00:00.000Z',
    );
    expect(Dates.parseISO('2023-05-09T23')?.toISOString()).toEqual(
        '2023-05-09T23:00:00.000Z',
    );
    expect(Dates.parseISO('2023-05-09T23:15')?.toISOString()).toEqual(
        '2023-05-09T23:15:00.000Z',
    );
    expect(Dates.parseISO('2023-05-09T23:15:22')?.toISOString()).toEqual(
        '2023-05-09T23:15:22.000Z',
    );
    expect(Dates.parseISO('2023-05-09T23:15:22.123Z')?.toISOString()).toEqual(
